  ...
  return (
    <div id="strengths" className="flex items-center justify-center py-40 bg-white">
      <div className="grid grid-rows-6 grid-flow-col gap-[24px] px-[16px] max-w-screen-xl">
        ...
        <div
          className={`flex flex-col row-span-4 gap-[10px] rounded-xl justify-between whitespace-pre-line break-keep p-8`}
          style={{ boxShadow: '0px 4px 17px 0px rgba(0, 0, 0, 0.15)' }}>
          <div className="flex flex-col gap-[10px]">
            <div className={'flex text-[36px] text-[#2B1710] leading-[1.3] font-bold'}>블록체인/Web3</div>
            <div className={'flex text-[24px] text-[#6A7C96] leading-[1.6]'}>
        ...
        <div
          className={`flex flex-col row-span-3 gap-[10px] rounded-xl justify-between whitespace-pre-line break-keep p-8`}
          style={{ boxShadow: '0px 4px 17px 0px rgba(0, 0, 0, 0.15)' }}>
          <div className="flex flex-col gap-[10px]">
            <div className={'flex text-[36px] text-[#2B1710] leading-[1.3] font-bold'}>메타버스/3D</div>
            <div className={'flex text-[24px] text-[#6A7C96] leading-[1.6]'}>
        ...
        <div
          ...
          style={{ boxShadow: '0px 4px 17px 0px rgba(0, 0, 0, 0.15)' }}>
          <div className="flex flex-col gap-[10px]">
            <div className={'flex text-[36px] text-[#2B1710] leading-[1.3] font-bold'}>이커머스</div>
            <div className={'flex text-[24px] text-[#6A7C96] leading-[1.6]'}>
