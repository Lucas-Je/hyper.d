...
const Strengths = () => {
  return (
    <div id="strengths" className="flex items-center justify-center py-20 md:py-40 bg-white">
      <div className="grid grid-cols-1 md:grid-rows-6 grid-flow-row md:grid-flow-col gap-[24px] px-[16px] max-w-screen-xl">
        ...
        <div
          ...
          <div className="flex flex-col gap-[10px]">
            ...
            <div className={'flex md:text-[24px] text-[#6A7C96] leading-[1.6]'}>
        ...
        <div
          ...
          style={{ boxShadow: '0px 4px 17px 0px rgba(0, 0, 0, 0.15)' }}>
          <div className="flex flex-col gap-[10px]">
            <div className={'flex text-[26px] md:text-[36px] text-[#2B1710] leading-[1.3] font-bold'}>이커머스</div>
            <div className={'flex md:text-[24px] text-[#6A7C96] leading-[1.6]'}>
